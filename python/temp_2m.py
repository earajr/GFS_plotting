...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_TMP2_SNGL.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/temp_2m')
...
os.system('mv *'+region+'_*TMP2_SNGL_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/temp_2m')
