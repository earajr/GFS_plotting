...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_meanwinds_'+lev1+'hPa_'+lev2+'hPa_SNGL.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/mean_winds_950_850')
...
os.system('mv *'+region+'_*meanwinds_'+lev1+'hPa_'+lev2+'hPa_SNGL_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/mean_winds_950_850')
