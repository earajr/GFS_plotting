...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_convergence_'+lev_hPa+'hPa.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/convergence_'+lev_hPa)
...
os.system('mv *'+region+'_*_convergence_'+lev_hPa+'hPa_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/convergence_'+lev_hPa)
