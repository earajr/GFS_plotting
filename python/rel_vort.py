...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_rel_vort_'+lev_hPa+'hPa.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/rel_vort_'+lev_hPa)
...
os.system('mv *'+region+'_*rel_vort_'+lev_hPa+'hPa_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/rel_vort_'+lev_hPa)
