...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_theta_'+lev_hPa+'hPa.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/theta_'+lev_hPa)
...
os.system('mv *'+region+'_*theta_'+lev_hPa+'hPa_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/theta_'+lev_hPa)
