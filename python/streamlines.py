...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_stream_'+lev_hPa+'hPa.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/streamlines_'+lev_hPa)
...
os.system('mv *'+region+'_*stream_'+lev_hPa+'hPa_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/streamlines_'+lev_hPa)
