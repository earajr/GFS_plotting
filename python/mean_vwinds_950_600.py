...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_meanVwinds_'+lev1+'hPa_'+lev2+'hPa_SNGL.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/mean_vwinds_950_600')
...
os.system('mv *'+region+'_*meanVwinds_'+lev1+'hPa_'+lev2+'hPa_SNGL_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/mean_vwinds_950_600')
