...
os.system('mv *_'+region+'_'+init_dt[0:10]+'_CAPECIN_SNGL.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/CAPE_CIN')
...
os.system('mv *'+region+'_*CAPECIN_SNGL_'+init_dt[0:10]+'*.png MARTIN/GFS/'+region+'/'+init_dt[0:10]+'/CAPE_CIN')
